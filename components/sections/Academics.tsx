...
import { COMBINATIONS, OLEVEL_SUBJECTS, ALEVEL_SUBJECTS } from "@/lib/data";
  ...
  return (
    <section id="academics" className="relative bg-white section-py">
      <Container>
        ...
        <div className="mt-20 rounded-2xl border border-navy-100 bg-mist p-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link href="/academics/results" className="group inline-flex items-center gap-2 font-semibold text-navy-700 hover:text-navy-900">
            See our NECTA results
            <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
          </Link>
          <span className="hidden text-slate-300 sm:inline">&middot;</span>
          <Link href="/admissions" className="group inline-flex items-center gap-2 font-semibold text-navy-700 hover:text-navy-900">
            Learn how to apply
            <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
          </Link>
        </div>
