...
export function Facilities() {
  return (
    <section id="facilities" className="relative scroll-mt-24 bg-mist section-py">
      <Container>
        <h2 className="font-heading text-2xl font-bold text-navy-900 md:text-3xl">Facilities</h2>
        <p className="mt-2 max-w-2xl text-slate-600">
          Science laboratories, ICT, library and boarding facilities that support the subjects above.
        </p>
