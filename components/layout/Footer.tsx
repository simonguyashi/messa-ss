...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-ink text-white pb-24 lg:pb-0">
      <div
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm text-white/65">
              ...
              <li><Link href="/academics/results" className="transition-colors hover:text-white">NECTA Results</Link></li>
            </ul>
          </div>
