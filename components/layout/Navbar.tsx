            ...
            {PRIMARY_NAV.map((item) => {
                ...
                return (
                  ...
                  >
                    <Link
                      href={item.href}
                      className={cn(
                        "flex items-center gap-1 rounded-full px-3.5 py-2 text-[13px] font-medium text-navy-700 transition-colors hover:bg-navy-50",
                    ...
                    <AnimatePresence>
                      {openDropdown === item.label && (
                        <motion.div
                          ...
                          className="absolute left-0 top-full w-72 overflow-hidden rounded-xl border border-navy-100 bg-white p-2 shadow-premium"
                        >
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "rounded-full px-3.5 py-2 text-[13px] font-medium text-navy-700 transition-colors hover:bg-navy-50",
                    active && "text-navy-900 bg-navy-50"
                  )}
                >
                  {item.label}
