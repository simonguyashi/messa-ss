...
| `/about` | What kind of school is this, and who leads it? |
| `/academics` | What do I study here? |
| `/academics/results` | How has the school performed? |
...
| `/downloads` | Where do I find official documents? |
| `/contact` | How do I reach the school? |

If a new section doesn't answer one of these clearly, it doesn't belong on the site — see the
UX audit shared with the school for full reasoning.
