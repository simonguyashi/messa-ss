...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { title: "About Messa Secondary School", description: "History, mission, vision and leadership", url: "/about", keywords: ["about", "history", "mission", "vision", "leadership", "historia"], group: "Page" },
