...
export const NEWS = [
  {
    ...
    body:
      "[Placeholder full article] Messa Secondary School has opened admissions for the 2026 academic year for both Form I and Form V applicants. Boarding and day options are available. Families are encouraged to begin the application process early, as boarding places are limited. Visit the Admissions page for requirements and the step-by-step process.",
    image: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=1200&auto=format&fit=crop",
    category: "Admissions",
  },
  {
    id: "n2",
    slug: "acsee-2026-top-5-ranking",
    ...
    body:
      "[Placeholder full article] Messa Secondary School's Form VI candidates achieved a 100% pass rate at the 2026 Advanced Certificate of Secondary Education Examination (ACSEE), with a GPA of 2.7381. The result places Messa among the top 5 private schools with 40+ candidates in both Mwanza City Council and Mwanza Region, and among the top 100 private schools nationally.",
  ...
  },
  {
    ...
    body:
      "[Placeholder full article] Messa Secondary School held its annual Inter-Class Sports Day, with students from Form I to Form VI competing in athletics and team sports. The event celebrated teamwork, discipline and school spirit.",
    image: "https://images.unsplash.com/photo-1526676037777-05a232554f77?q=80&w=1200&auto=format&fit=crop",
    category: "School Life",
  },
  {
    id: "n4",
    slug: "form-six-graduation",
    ...
    body:
      "[Placeholder full article] Messa Secondary School celebrated the graduation of its Form VI class in a ceremony attended by parents, staff and invited guests, marking the completion of the students' A-Level journey.",
    image: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=1200&auto=format&fit=crop",
    category: "Events",
  },
  {
    ...
    body:
      "[Placeholder full article] Students from the Physics, Chemistry, Biology and Computer Science departments showcased original projects at Messa's annual Science & Innovation Fair, reflecting the school's strong focus on the sciences and ICT.",
...
// ----------------------------------------------------------------------------
// Admissions FAQ — [PLACEHOLDER] answers where policy detail isn't published
// on the official profile.
// ----------------------------------------------------------------------------
export const ADMISSIONS_FAQ = [
  {
    q: "How does Form I admission work?",
    a: "Form I placement follows the government TAMISEMI selection system based on Standard VII examination results. Selected students report to Messa with their joining instructions.",
  },
  {
    q: "Can I apply directly for Form V (A-Level)?",
    a: "Yes. Form V applicants apply directly to the school with their CSEE results and chosen combination. [PLACEHOLDER] Contact the admissions office for the current minimum entry points.",
  },
  {
    q: "Is boarding compulsory?",
    a: "No. Messa operates as both a Boarding and Day school — families may choose either option. [PLACEHOLDER] Boarding capacity may be limited each year.",
  },
  {
    q: "What documents are required at registration?",
    a: "[PLACEHOLDER] Typically: birth certificate, Standard VII or CSEE result slip, passport photos, and immunisation record. See the Downloads Centre for the full checklist once published.",
  },
  {
    q: "When does the academic year begin?",
    a: "[PLACEHOLDER] Refer to the Academic Calendar in the Downloads Centre for exact term dates.",
  },
];

// [PLACEHOLDER] Fee structure — not published on the official profile.
export const FEE_NOTICE = {
  headline: "Fee Structure",
  note:
    "[PLACEHOLDER] The published fee schedule will appear here once provided by the school office. In the meantime, please contact the school directly for current fee information for Day and Boarding students.",
};

// [PLACEHOLDER] Leadership — not published on the official profile. Structure
// reflects typical Tanzanian secondary school administration roles.
export const LEADERSHIP = [
  { name: "[Placeholder Name]", role: "Head of School", group: "Administration" },
  { name: "[Placeholder Name]", role: "Deputy Head of School", group: "Administration" },
  { name: "[Placeholder Name]", role: "Academic Master / Mistress", group: "Administration" },
  { name: "[Placeholder Name]", role: "Discipline Master / Mistress", group: "Administration" },
  { name: "[Placeholder Name]", role: "Boarding Master / Mistress", group: "Administration" },
  { name: "[Placeholder Name]", role: "Bursar", group: "Administration" },
  { name: "[Placeholder Name]", role: "Head of Sciences Department", group: "Heads of Department" },
  { name: "[Placeholder Name]", role: "Head of Languages Department", group: "Heads of Department" },
  { name: "[Placeholder Name]", role: "Head of Humanities Department", group: "Heads of Department" },
  { name: "[Placeholder Name]", role: "Head of Business Studies Department", group: "Heads of Department" },
];
