...
// [PLACEHOLDER] Leadership — not published on the official profile.
export const LEADERSHIP = [
  { name: "[Placeholder Name]", role: "Head of School" },
  { name: "[Placeholder Name]", role: "Academic Master / Mistress" },
  { name: "[Placeholder Name]", role: "Boarding Master / Mistress" },
  { name: "[Placeholder Name]", role: "Bursar" },
];
